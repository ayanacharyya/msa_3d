...
def parse_args():
    ...
    parser.add_argument('--nodered', dest='nodered', action='store_true', default=False, help='Skip de-reddening emission lines? Default is no.')
    ...
    parser.add_argument('--plot_line_flux_maps', dest='plot_line_flux_maps', action='store_true', default=False, help='Plot the line flux maps for a given galaxy? Default is no.')
    ...
    if args.ncores is None:
        if args.debug_linefit is not None: args.ncores = 1
        else: args.ncores = cpu_count() - 1
...
# --------------------------------------------------------------------------------------------------------------------
def annotate_axes(ax, xlabel, ylabel, xlim=None, ylim=None, args=None, fontsize=10, fontfactor=1, label='', clabel='', hide_xaxis=False, hide_yaxis=False, hide_cbar=True, p=None, hide_cbar_ticks=False, cticks_integer=True, label_color='k', bbox=True):
    '''
